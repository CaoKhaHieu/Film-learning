...
export function LoginModal({ isOpen, onClose }: LoginModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white rounded-2xl p-8 shadow-2xl w-full max-w-md relative animate-in zoom-in-95 duration-200 m-4">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="text-center mb-8">
          <h2 className="text-xl font-bold text-slate-800 mb-2">Lưu từ vựng của bạn</h2>
          <p className="text-slate-500 text-sm">
            Đăng nhập để lưu từ vựng, theo dõi tiến độ và học tập hiệu quả hơn trên nhiều thiết bị.
          </p>
        </div>
