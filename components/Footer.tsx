      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><a href="/beginner" className="hover:text-yellow-500 transition-colors">Cấp độ Cơ bản</a></li>
            <li><a href="/intermediate" className="hover:text-yellow-500 transition-colors">Cấp độ Trung cấp</a></li>
            <li><a href="/advanced" className="hover:text-yellow-500 transition-colors">Cấp độ Nâng cao</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><a href="#" className="hover:text-yellow-500 transition-colors">Hướng dẫn sử dụng</a></li>
